#!/usr/bin/env bash
# V0rtexOS — ArchISO Profile (ARM64 genérico)
# Targets: ARM64 bare metal, celulares (Termux/Chroot), tablets

iso_name="v0rtex-os-arm64"
iso_label="V0RTEX_ARM64"
iso_publisher="V0rtex Security"
iso_application="V0rtexOS — Grey Hat Linux — ARM64 Edition"
